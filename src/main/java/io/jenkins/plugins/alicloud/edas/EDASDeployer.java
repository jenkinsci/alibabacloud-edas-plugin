...
public abstract class EDASDeployer {
    ...
    public boolean perform() throws Exception {
        ...
        EDASUtils.edasLog(listener, String.format("appId %s found", appId));
        logger.log(Level.INFO, String.format("appId %s found", appId));
        ...
        EDASUtils.edasLog(listener, String.format("changeOrderId %s", changeOrderId));
